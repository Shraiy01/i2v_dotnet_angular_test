...
4. Ex: If you enter `archit` in the input field, the hash value should be `92A1B1799146E7EBE480694175806E3A01755A84D9F316B807D7D9C6280FE6B8` for the name `John` as per the correct logic to be `96D9632F363564CC3032521409CF22A852F2032EEC099ED5967C0D000CEC607A` this is the hash value for `John`.
